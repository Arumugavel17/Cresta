...
namespace Cresta 
{
	...
	void OpenGLFramebuffer::Recreate()
	{
		...
		if (p_DepthAttachmentSpecification.TextureFormat != FramebufferTextureFormat::None)
		{
			...
			case FramebufferTextureFormat::DEPTH24STENCIL8:
				Utils::AttachDepthTexture(p_DepthAttachment, m_Specification.Samples, GL_DEPTH_COMPONENT32F, GL_DEPTH_ATTACHMENT, m_Specification.Width, m_Specification.Height);
				break;
			}
		}
	...
	void OpenGLFramebuffer::SetBufferSize(void* AttachmentArrya, int size)
	{
		glDrawBuffers(size, (GLenum*)AttachmentArrya);
	}
