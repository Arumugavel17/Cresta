...
namespace Cresta
{
	...
	void PhysicsController::GetBodyRotation(const UUID& EntityID, glm::quat& rotation)
	{
	...
	void PhysicsController::GetBodyPosition(const UUID& EntityID, glm::vec3& position)
	{
